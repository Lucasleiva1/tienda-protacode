 ...
 *
 * Hoy siempre es `not_requested`. Una licencia solo puede pedirse DESPUÉS de un pago
 * aprobado y verificado en el servidor, nunca al crear el pedido.
 */
export type LicenseStatus = "not_requested" | "pending" | "issued" | "failed";
